...
class Back(Task):
    def __init__(self, settings={}):
        ...
        The possible settings are:
            ...
            - edge_thinning: How much edges must be thinned in the resulting
              mask. `0' or `1' means no thinning at all, `-1` means ignoring
              edges in the resulting mask.
              (default: 3)
    ...
    def _floodfill(self, img):
        back = 255 - img
        back = _sobel(back, self.settings['blur_radius'])
